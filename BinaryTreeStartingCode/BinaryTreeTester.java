 ...
 * @author Jonny Tang: added expression testing in basicTest() on 11/7/2025
 * 
 * @author Nathan Dalal
 * @version 11/13/13
 */
public class BinaryTreeTester
{
    ...
    private void basicTest()
    {
        ...
        int randomDepth = (int)(Math.random()*2) + 2;
        ...
        System.out.println("Give an expression for me to evaluate.");
        Scanner in = new Scanner (System.in);
        String expression = in.nextLine();
        
        TreeNode trEval = util.createExpressionTree(expression);
        display.displayTree(trEval);
        
        System.out.println("\nYour expression evaluates to: " + util.eval(trEval, display));
    }
