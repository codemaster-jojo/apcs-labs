...
public class Sorter
{
    ...
    */
    ...
    /**
     * Method: indexOfMin()
     * Usage: finds the minimum of an array starting at given index
     * @param a the array
     * @param startIndex starting from this index
     ...
     * Usage: chooses smallest element and move to the 
     * front of array. then repeat.
     * @param a the array
    ...
    /**
     * Method: insert()
     * Usage: Inserts one value at nextIndex to the values 
     * before nextIndex. Maintain sorted order.
     * @param a the array
     * @param nextIndex the value index
     */
    public void insert(Comparable[] a, int nextIndex)
    {
        ...
        while (i >= 0 && a[i].compareTo(value) > 0)
        {
            a[i+1] = a[i];
            i--;
        }
     ...
     * Usage: sorts using insert() method
     * @param a the array
     */
    ...
    /**
     * Method: mergesort()
     * Usage: merge sort using "divide and conquer"
     * @param a the array
     */
     ...
     * Usage: the helper that runs everything taking low and high index
     * @param a the array
     * @param lowIndex the low
     * @param highIndex the high
     */
    ...
    {   
        ...
        mergesortHelp(a, mid, highIndex);
        
        // merge two halves
        Comparable[] tempArr = new Comparable[highIndex - lowIndex];
